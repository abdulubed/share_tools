...
s3_folder_type      =  "ec2"
s3_tfstate_file     =  "ec2-kafka-consumer-connector-1.tfstate"
region              =  "us-west-2"
## End terrafom tfstate configuration 


## Ec2 consumer instance configuration
key_pair            =  "czr-raas-keypair-usw2-prod-ec2-kafka-consumer-connector"
aws_ami             =  "ami-0db150645c6d57e58"
instance_type       =  "c5.xlarge"
application         =  "kafka-consumer-connector-win-1"

## Networking setup 
availability_zone       = "us-west-2a"
vpc_id                  = "vpc-0be93057a37888aa2"
subnet_id               = "subnet-0de0b4ea92c1c2d0f"
private_ip              = "10.34.83.233"
secondary_private_ips   = []
hostname                = "ENTAKAFKACON01"
...
sg_ingress_rules_sg_ids_others = [
    {
        ...
        description = "czr-raas-security-group-usw2-prod-sql-server-win-1"
    },
    {
        from_port   = 445
        to_port     = 445
        protocol    = "tcp"
        source_security_group_id = "sg-0823ed516c201959f"
        description = "czr-raas-security-group-usw2-prod-sql-server-win-2"
    }
]
...
backup_plan                     = "czr-raas-backup-plan-usw2-prod-ec2-kafka-consumer-connector-1"
...
backup_resource                 = "czr-raas-backup-selection-usw2-prod-ec2-consumer"
...
#Iam role
iam_role_name               = "czr-raas-role-prod-kafka-consumer-connector-win-1"
iam_profile_name            = "czr-raas-profile-prod-kafka-consumer-connector-win-1"
