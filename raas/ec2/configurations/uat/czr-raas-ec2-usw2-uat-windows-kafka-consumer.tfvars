...
key_pair            =  "czr-raas-keypair-usw2-uat-ec2-kafka-consumer-connector"
aws_ami             =  "ami-0db150645c6d57e58"
instance_type       =  "c5.large"
application         =  "kafka-consumer-connector-win"

## Networking setup 
availability_zone       = "us-west-2b"
vpc_id                  = "vpc-0ecae39fab919b590"
subnet_id               = "subnet-09a95e7440750bbad"
private_ip              = "10.34.75.93"
secondary_private_ips   = []
hostname                = "UATAKAFKACON01"
...
sg_ingress_rules_sg_ids_others = [
    {
        ...
        to_port     = 445
        protocol    = "tcp"
        source_security_group_id = "sg-0a2696ffae48448b8"
        description = "czr-raas-security-group-usw2-uat-sql-server-win-1"
    },
    {
        from_port   = 445
        to_port     = 445
        ...
        description = "czr-raas-security-group-usw2-uat-sql-server-win-2"
    }
]
...
backup_plan                     = "czr-raas-backup-plan-usw2-uat-ec2-kafka-consumer-connector"
...
backup_resource                 = "czr-raas-backup-selection-usw2-uat-ec2-consumer"
...
#Iam role
iam_role_name               = "czr-raas-role-uat-kafka-consumer-connector-win"
iam_profile_name            = "czr-raas-profile-uat-kafka-consumer-connector-win"
