...
secrets_raas_database              = "czr-raas-secret-usw2-uat-db-config"
database_description               = "Database credentials"

secrets_raas_jwt                   = "czr-raas-secret-usw2-uat-jwt-keys"
jwt_description                    = "JWT token secret keys"

secrets_raas_strikeiron            = "czr-raas-secret-usw2-uat-strikeiron-config"
strikeiron_description             = "Strikeiron API Config keys"

secrets_raas_eml                   = "czr-raas-secret-usw2-uat-eml-keys"
eml_description                    = "EML - Email service API Config keys"

secrets_raas_gms                   = "czr-raas-secret-usw2-uat-gms-key"
gms_description                    = "API Key & secret for GMS APIs"

secrets_raas_gms_guest             = "czr-raas-secret-usw2-uat-gms-create-guest-key"
gms_guest_description              = "GMS - Create guest Account API Config keys"


secrets_raas_pdb_republish         = "czr-raas-secret-usw2-uat-pdb-republish"
pdb_republish_description          = "PDB Republish API Config keys"

secrets_raas_kafka                 = "czr-raas-secret-usw2-uat-kafka-config"
kafka_description                  = "Kafka configuration Keys"

secrets_raas_security_questions_limit  = "czr-raas-secret-usw2-uat-security-questions-limit"
security_questions_limit_description   = "Security questions configurable value"

secrets_raas_aws_lambda_enc_secret     = "czr-raas-secret-usw2-uat-aws-lambda-enc-secret"
aws_lambda_enc_secret_description      = "AWS Lambda Encryption Secret key"

secrets_raas_sms_service_config        = "czr-raas-secret-usw2-uat-sms-service-config"
sms_service_config_description         = "Sms service configuration Secret key"

secrets_raas_gms_get_rg_info           = "czr-raas-secret-usw2-uat-gms-get-rg-info"
gms_get_rg_info_description            = "Gms get rg info Secret key"

secrets_raas_error_logger              = "czr-raas-secret-usw2-uat-caesars-error-logger"
error_logger_description               = "Caesars Error Logger URL"

secrets_raas_gms_validate_oauthtoken   = "czr-raas-secret-usw2-uat-gms-validate-oauthtoken-key"
gms_validate_oauthtoken_description    = "Validate OAuth token Secret key"

secrets_raas_leap_auth_provider       = "czr-raas-secret-usw2-uat-leap-auth-provider-keys"
leap_auth_provider_description        = "leap auth provider keys"
secrets_raas_sa_get_rg_info           = "czr-raas-secret-usw2-uat-sa-get-rg-info"
sa_get_rg_info_description            = "standardize address info Secret key"

secrets_raas_offers_database           = "czr-raas-offers-secret-usw2-uat-db-config"
secrets_raas_offers_database_description= "Database credentials for RaaS Offers"

## Database information     
# Database values         
database_username                =  "rewards"
database_host                    =  "czr-raas-nlb-usw2-uat-sql-server-340814875659861a.elb.us-west-2.amazonaws.com"
...
# jwt values
jwt_internal                    = "jYi47n8sewJgHiEfdle3da0C51tGZpE9"
jwt_auth                        = "NhtF0TrNtPjjyIEoRVgLTqiRuT7lRUqF"
jwt_mfa                         = "bE21WFvQXHYU7oR225MdjSVetYHAn4Aj"
...
crypto_secret                  = "WSfsuHy9PmnmXzTfkCM7UfsEc34oGR1X"
standard_string                = "649y04" 
...
#error logger values
error_logger_url               = "http://10.34.75.93/errorlogging/Logger.asmx/LogError"
