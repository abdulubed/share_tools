...
secrets_lambda_mtd_cvps_database_server1    = "czr-baas-secret-dev-mtd-cvps-database-server1-test1"
database_server1_description                = "secrets for baas lambda mtd database server1"

secrets_lambda_mtd_cvps_database_server2    = "czr-baas-secret-dev-mtd-cvps-database-server2-test1"
database_server2_description                = "secrets for baas lambda mtd database server2"

secrets_lambda_mtd_cvps_snowflake           = "czr-baas-secret-dev-mtd-cvps-snowflake-test1"
...
# snowflake values
snowflake_username  = "DAAS_SOX_APP_USER_DEV"
snowflake_engine    = "sqlserver"
snowflake_host      = "aia54988.us-west-2.privatelink"
snowflake_port      = "5432"
snowflake_dbname    = "DAAS_DEV"
snowflake_schema    = "DAAS_CORE_SOX"
snowflake_role      = "DAAS_SOX_APP_USER_DEV_DEV"
snowflake_warehouse = "DAAS_DEV_XSMALL"
