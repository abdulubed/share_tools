...
secrets_lambda_mtd_cvps_database_server1    = "czr-baas-secret-uat-mtd-cvps-database-server1"
database_server1_description                = "secrets for baas lambda mtd database server1"

secrets_lambda_mtd_cvps_database_server2    = "czr-baas-secret-uat-mtd-cvps-database-server2"
database_server2_description                = "secrets for baas lambda mtd database server2"

secrets_lambda_mtd_cvps_snowflake           = "czr-baas-secret-uat-mtd-cvps-snowflake"
...
# snowflake values
snowflake_username  = "DAAS_SOX_APP_USER_UAT"
snowflake_engine    = "sqlserver"
snowflake_host      = "aia54988.us-west-2.privatelink"
snowflake_port      = "5432"
snowflake_dbname    = "DAAS_UAT"
snowflake_schema    = "DAAS_CORE_SOX"
snowflake_role      = "DAAS_SOX_APP_USER_UAT_UAT"
snowflake_warehouse = "DAAS_UAT_XSMALL"
